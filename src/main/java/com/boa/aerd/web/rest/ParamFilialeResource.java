...
import com.boa.aerd.service.ParamFilialeService;
...
/**
 * REST controller for managing {@link com.boa.aerd.domain.ParamFiliale}.
 */
@RestController
@RequestMapping("/api")
@ApiIgnore
public class ParamFilialeResource {
    ...
    public ResponseEntity<ParamFiliale> updateParamFiliale(@RequestBody ParamFiliale paramFiliale) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paramFiliale.getId().toString()))
            .body(result);
    }
